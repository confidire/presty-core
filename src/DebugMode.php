...
//     <div style="background: #d2e9f3;color: #262626db;padding:0 6px;float:right;line-height:30px;font-size:14px;">'.round(number_format (microtime (true) - SYSTEM_START_TIME, 10, '.', ''),6).'s </div>
